...
import {
    ...
    FILMSTRIP_TYPE,
    TOOLBAR_HEIGHT,
    TOOLBAR_HEIGHT_MOBILE } from '../../../../filmstrip/constants';
import { isFilmstripResizable, showGridInVerticalView } from '../../../../filmstrip/functions.web';
...
const KoreanMainFilmstrip = (props: IProps) => (
    <span>
        <Filmstrip
            { ...props }
...
export default connect(_mapStateToProps)(KoreanMainFilmstrip);
