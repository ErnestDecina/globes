...
import { areSmileysDisabled } from '../../../../chat/functions';

import SmileysPanel from '../../../../chat/components/web/SmileysPanel';
 ...
 * @augments Component
 */
class KoreanChatInput extends Component<IProps, IState> {
...
export default translate(connect(mapStateToProps)(KoreanChatInput));
