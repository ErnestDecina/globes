...
import Thumbnail from '../../../../filmstrip/components/web/Thumbnail';
import ThumbnailWrapper from '../../../../filmstrip/components/web/ThumbnailWrapper';
import { styles } from '../../../../filmstrip/components/web/styles';
 ...
 * @augments Component
 */
class KoreanFilmstrip extends PureComponent <IProps, IState> {
...
export default withStyles(translate(connect(_mapStateToProps)(KoreanFilmstrip)), styles);
